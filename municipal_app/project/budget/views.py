...
def budget_annuel():
    if Budget_annuelle.query.filter_by(municipal_id=current_user.municipal_id).first():
        ...
        auto_list = [{'file_name': recette_link_simple, 'link': rcs, 'text': u'نفقات تقديم عمودي لسنوات ' +  year_str, 'type': 'an_rec_h'},
                     {'file_name': recette_link_per_year, 'link': rcy, 'text': u'النفقات تقديم أفقي لسنوات ' +  year_str, 'type': 'an_rec_v'},
                     {'file_name': depecence_link_simple, 'link': dps, 'text': u'موارد تقديم عمودي لسنوات '+  year_str, 'type': 'an_dep_h'},
                     {'file_name': depecence_link_per_year, 'link': dpy, 'text': u'الموارد تقديم أفقي لسنوات ' +  year_str, 'type': 'an_dep_v'}]
